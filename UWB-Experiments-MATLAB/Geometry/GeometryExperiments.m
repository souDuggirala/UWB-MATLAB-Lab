...
GeoExp('TagElevated',x_anch_height,y_anch_height,X_TRUE,Y_TRUE,BUFFER_POS);
GeoExp('AnchorsElevated',x_anch_height,y_anch_height,X_TRUE,Y_TRUE,BUFFER_POS);
GeoExp('SquareTopology',x_anch_height,y_anch_height,X_TRUE,Y_TRUE,BUFFER_POS);
GeoExp('TriangleTopology',x_anch_tri,y_anch_tri,X_TRUE,Y_TRUE,BUFFER_POS);
GeoExp('SingleSideOneAnchorBack',x_anch_one_side,y_anch_one_side,X_TRUE,Y_TRUE,BUFFER_POS);
...
pos_plot(x_true, y_true, x_tag_pos_avg, y_tag_pos_avg, x_tag_pos_std,y_tag_pos_std,...
    x_anch_pos, y_anch_pos, buffer_pos, name);
